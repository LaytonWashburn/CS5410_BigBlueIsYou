...
public class CreateSprites {
    ...
    public static Entity createBigBlue(Texture texture, float posX, float posY){
        ...
        bigBlue.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordWall(Texture texture, float posX, float posY){
        ...
        wordWall.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordIs(Texture texture, float posX, float posY){
        ...
        wordIs.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordStop(Texture texture, float posX, float posY){
        ...
        wordStop.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordPush(Texture texture, float posX, float posY){
        ...
        wordPush.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordWin(Texture texture, float posX, float posY){
        ...
        wordWin.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordYou(Texture texture, float posX, float posY){
        ...
        wordYou.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordSink(Texture texture, float posX, float posY){
        ...
        wordSink.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordKill(Texture texture, float posX, float posY){
        ...
        wordKill.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordBaba(Texture texture, float posX, float posY){
        ...
        wordBaba.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordLava(Texture texture, float posX, float posY){
        ...
        wordLava.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
    ...
    public static Entity createWordWater(Texture texture, float posX, float posY){
        ...
        wordWater.add(new ecs.Components.Sprite(new AnimatedSprite(texture, new float[] {.2f, .2f, .2f}, new Vector2f(.1f, .1f), new Vector2f(posX, posY))));
